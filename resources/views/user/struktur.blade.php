...
<body>
    ...
    <!-- end navbar -->
    {{-- Section struktur Sekolah --}}
    <section id="struktur" class="struktur-sekolah py-5 fade-in">
        <div class="container">
            <h2 class="text-center fw-bold text-success mb-5">Struktur Organisasi</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-kepala-sekolah.jpg" class="card-img-top" alt="Kepala Sekolah">
                        <div class="card-body">
                            <h5 class="card-title">Kepala Sekolah</h5>
                            <p class="card-text">Bertanggung jawab atas seluruh kegiatan pendidikan dan operasional
                                sekolah.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-wakil-sekolah.jpg" class="card-img-top" alt="Wakil Kepala Sekolah">
                        <div class="card-body">
                            <h5 class="card-title">Wakil Kepala Sekolah</h5>
                            <p class="card-text">Membantu kepala sekolah dalam menjalankan tugasnya, serta bertanggung
                                jawab di bidang tertentu.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-bendahara.jpg" class="card-img-top" alt="Bendahara">
                        <div class="card-body">
                            <h5 class="card-title">Bendahara</h5>
                            <p class="card-text">Mengelola keuangan sekolah dan bertanggung jawab atas laporan keuangan.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-guru.jpg" class="card-img-top" alt="Guru">
                        <div class="card-body">
                            <h5 class="card-title">Guru</h5>
                            <p class="card-text">Melaksanakan proses pembelajaran sesuai dengan kurikulum yang berlaku.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-staf.jpg" class="card-img-top" alt="Staf Administrasi">
                        <div class="card-body">
                            <h5 class="card-title">Staf Administrasi</h5>
                            <p class="card-text">Menangani segala urusan administrasi sekolah, termasuk arsip dan
                                surat-menyurat.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card text-center border-0 shadow-sm">
                        <img src="gambar-kesiswaan.jpg" class="card-img-top" alt="Kesiswaan">
                        <div class="card-body">
                            <h5 class="card-title">Kesiswaan</h5>
                            <p class="card-text">Bertanggung jawab dalam urusan kesejahteraan dan kegiatan siswa di
                                sekolah.</p>
                        </div>
                    </div>
                </div>
