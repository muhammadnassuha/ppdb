...
<body>
    ...
    <section class="profil-section py-5 fade-in">
        <div class="container">
            <div class="row align-items-center">

                <!-- Gambar Sekolah -->
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('images/foto sekolah.JPG') }}" alt="Foto Sekolah"
                        class="img-fluid rounded shadow">
                </div>

                <!-- Teks Profil -->
                <div class="col-md-6">
                    <h2 class="fw-bold mb-4 text-success">Profil MTs Darul Hikmah</h2>

                    <div class="profil-item mb-4">
                        <h4 class="fw-semibold text-dark mb-2">Sejarah Singkat</h4>
                        <p class="text-justify">
                            MTs Darul Hikmah didirikan pada tahun <strong>2005</strong> sebagai bentuk kepedulian
                            terhadap pentingnya pendidikan Islam di tengah masyarakat. Berawal dari 3 ruang kelas dan 30
                            siswa, kini telah berkembang menjadi lembaga pendidikan unggulan yang konsisten mencetak
                            generasi yang berilmu dan berakhlak mulia.
                        </p>
                    </div>

                    <div class="profil-item mb-4">
                        <h4 class="fw-semibold text-dark mb-2">Perkembangan dan Prestasi</h4>
                        <p class="text-justify">
                            Selama lebih dari satu dekade, MTs Darul Hikmah telah meraih berbagai prestasi, baik di
                            bidang akademik maupun non-akademik. Pada tahun <strong>2018</strong>, sekolah ini meraih
                            penghargaan sebagai "Madrasah Teladan Kabupaten" berkat program pendidikan karakter dan
                            sistem pembelajaran berbasis digital.
                        </p>
                    </div>

                    <div class="profil-item">
                        <h4 class="fw-semibold text-dark mb-2">Visi dan Harapan</h4>
                        <p class="text-justify">
                            Dengan jumlah siswa lebih dari <strong>350 orang</strong>, MTs Darul Hikmah terus berinovasi
                            untuk menjadi madrasah modern yang tetap menjunjung tinggi nilai-nilai keislaman. Visi ke
                            depan adalah menjadi madrasah unggulan dalam pembentukan generasi Qur'ani yang cerdas,
