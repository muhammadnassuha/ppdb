...
<body>
    ...
    <section class="visi-misi-section py-5 fade-in">
        <div class="container">
            <div class="row align-items-center">

                <!-- Ilustrasi Gambar -->
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="{{ asset('images/gambar 1.jpg') }}" alt="Ilustrasi Visi Misi"
                ...
                <div class="col-md-6">
                    ...
                    <div class="visi mb-4">
                        ...
                        <p class="lead text-justify">
                            "Menjadi lembaga pendidikan Islam unggulan yang berkarakter, berprestasi, dan berakhlak
                            mulia."
                        </p>
                    </div>
                    ...
                    <div class="misi">
                        ...
                        <ul class="list-unstyled">
                            <li>1. Menanamkan nilai-nilai Islam dalam seluruh aspek kehidupan siswa.</li>
                            <li>2. Meningkatkan mutu pembelajaran berbasis teknologi dan kreativitas.</li>
                            <li>3. Membentuk karakter disiplin, jujur, dan tanggung jawab pada siswa.</li>
                            <li>4. Mengembangkan potensi akademik dan non-akademik secara seimbang.</li>
                            <li>5. Meningkatkan kompetensi tenaga pendidik dan kependidikan.</li>
                        </ul>
                    </div>
                </div>
