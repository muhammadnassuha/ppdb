...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/css_admin/layout.css')); ?>">
...
<body style="font-family: 'Poppins', sans-serif;">
    <div class="d-flex" style="min-height: 100vh;">
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-3 shadow-sm"
            ...
            <!-- Menu atas -->
            <div class="mt-4">
                <a href="<?php echo e(route('admin.index')); ?>" class="d-block mb-3 text-white text-decoration-none">
                    <i class="fas fa-tachometer-alt me-2"></i> Dashboard
                </a>
                <hr class="bg-white" />
                <a href="<?php echo e(route('admin.pendaftar')); ?>" class="d-block mb-3 text-white text-decoration-none">
                    <i class="fas fa-user-graduate me-2"></i> Data Pendaftar
                </a>
                <hr class="bg-white" />
                <a href="<?php echo e(route('admin.berita.index')); ?>" class="d-block mb-3 text-white text-decoration-none">
                    <i class="fas fa-id-card me-2"></i> Manajemen Berita
                </a>
                <hr class="bg-white" />
                <a href="<?php echo e(route('admin.pengumuman.index')); ?>" class="d-block mb-3 text-white text-decoration-none">
...
<?php /**PATH C:\laragon\www\ppdb\resources\views/admin/layout.blade.php ENDPATH**/ ?>